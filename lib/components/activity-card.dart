                                    ...
                                    children: <Widget>[
                                        ...
                                        Container(
                                            ...
                                            child: Padding(
                                                ...
                                                child: model.isLoading ? SpinKitCircle(
                                                    color: Colors.grey,
                                                    size: 30.0,
                                                ) : Icon(
                                                    model.isSubscribed ? FontAwesomeIcons.checkCircle : FontAwesomeIcons.timesCircle,
                                                    color: model.isSubscribed ? Colors.green : Colors.red,
                                                    size: 30.0
                                                )
                                            )
                                        )
                                    ...
                                    Padding(
                                        ...
                                        child: PillButton(
                                            ...
                                            child: Padding(
                                                ...
                                                child: Text(
                                                    model.isSubscribed ? LocalizationService
                                                        .of(context)
